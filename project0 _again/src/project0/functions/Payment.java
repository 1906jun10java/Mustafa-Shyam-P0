...
public class Payment {
	...
	public Payment(int payID, Double downpayment, Double principal, Double interest_rate, Integer num_months,
			Double payment) {
		super();
		this.payID = payID;
	...
	public void setIndex(int payID) {
		this.payID = payID;
	}
	...
	public String toString() {
		return "Payment [payID=" + payID + ", downpayment=" + downpayment + ", principal=" + principal
